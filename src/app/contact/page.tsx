          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-2xl">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Better yet, see us in person!</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        STABDHA UTILITY INSIGHTS PRIVATE LIMITED<br />
                        Business Address<br />
                        City, State, ZIP Code
                      </p>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@suipl.in</p>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm mb-3">Questions about our services or company</p>
                  <a href="mailto:info@suipl.in" className="text-blue-600 hover:text-blue-700 font-medium">
                    info@suipl.in
                  </a>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm mb-3">Partnership and collaboration opportunities</p>
                  <a href="mailto:business@suipl.in" className="text-blue-600 hover:text-blue-700 font-medium">
                    business@suipl.in
                  </a>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose SUIPL?</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We are committed to providing exceptional service and building lasting partnerships
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our certified professionals bring years of experience in utility management and business analytics.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Ongoing support and maintenance to ensure your systems run smoothly and efficiently.
              </p>
            </div>
          </div>
        </div>
